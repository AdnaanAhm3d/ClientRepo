...
import streamadmincenter from '../Assets/Images/project-1/compressed-images/Stream admin center.jpg'
import spac from '../Assets/Images/project-1/compressed-images/SP AC.jpg'
import streamtilesettings from '../Assets/Images/project-1/compressed-images/Stream tile settings.jpg'
import m365 from '../Assets/Images/project-1/compressed-images/M365 Stream Tile.jpg'
import restrictvideouploadonstream from '../Assets/Images/project-1/compressed-images/Restrict video upload on Stream.png'
import messageadminsettings from '../Assets/Images/project-1/compressed-images/Message admin settings.jpg'
import enduserimage from '../Assets/Images/project-1/compressed-images/End user message.jpg'
// videos
        ...
        <div className='project-center'>
          ...
          <div className='core-flow'>
            ...
            <div className='fre-migrations-tab'>
              <div className='fre-scans-tab-grey'>
                <button className='collapse-btn' onClick={collapsedBFunc}>
                  <h4>
                    <svg
                      width='11'
                      height='9'
                ...
                <div
                  className={`${
                    collapsedB ? 'fre-scan-extra video-grid' : 'video-grid'
                  }`}
                >
                  <video
                    controls
          ...
          <Link to='/project'>
            <div className='next-project'>
              <div className='header'>
                <h2>Next Project</h2>
                <h3>Microsoft Stream Mobile App</h3>
              </div>
